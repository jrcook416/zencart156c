...
//
define ('BOX_TOOLS_DBIO', 'Database I/O Manager');
define ('BOX_CONFIGURATION_DBIO', 'DbIo Manager Settings');
define ('BOX_TOOLS_DBIO_CUSTOMIZE', 'Manage DbIo Templates');

// -----
// Messages common to multiple DbIo tools.
//
