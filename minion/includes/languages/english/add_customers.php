...
// added to prevent php constant warnings
// Moved to beginning of the file as warnings were being logged when the require was called after the define was referenced Steve
if (!defined('TEXT_GV_NAME') || !defined('TEXT_GV_REDEEM')) {
